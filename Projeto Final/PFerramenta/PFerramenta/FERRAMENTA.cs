...
namespace PFerramenta
{
    internal class FERRAMENTA
    {
        ...
        public DataTable Listar()
        {
            ...
            try
            {
                daFerramenta = new SqlDataAdapter("SELECT * FROM FERRAMENTA", Form1.conexao);
        ...
        public int Salvar()
        {
            ...
            try
            {
                ...
                mycommand = new SqlCommand("INSERT INTO FERRAMENTA VALUES" + "(@nome, @fornecedor, @distribuicao, @dtcadastro, @siteoficial, @categoria_idcategoria)", Form1.conexao);
